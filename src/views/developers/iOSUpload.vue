      ...
      <b-col md="12" lg="8" offset-lg="2">
        <b-card>
          ...
          <b-form>
            ...
            <hr />
            <b-form-group label="上傳 PList" label-for="fileInputPList" :label-cols="3">
              <input type="file" id="plist" ref="plist" />
              <!-- <b-form-file id="fileInputPList" :plain="true"></b-form-file> -->
            </b-form-group>
            <hr />
